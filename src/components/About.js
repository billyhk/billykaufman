	...
	<>
		<main className='about-main'>
			...
			<p className='about-caption'>
				Hi, my name is Billy. I create <span className='stylish'>stylish</span>,{' '}
			...
			<p className='about-caption'>
				...
				, and have a background in music performance. As an orchestral
				percussionist, I have enjoyed the creative process of mastering a skill;
				this ambition carries over as a programmer.
			</p>
			...
			<a
				...
				href='https://drive.google.com/file/d/1f4UMXV78mckLaDSNc-5-oKod1bzibqWU/view?usp=sharing'
				target='_blank'
				rel='noopener noreferrer'>
				<FaFilePdf />
			</a>
