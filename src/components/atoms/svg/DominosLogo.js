...
const DominosLogo = ({ width }) => (
  <svg viewBox='18.5 18.2 162.9 163.7' width={width}>
    <path
      fill='#FFFFFF'
    ...
    <path
      fill='#006491'
      d='M71.8,76l51.9,51.9l-47.2,47.2c-2.9,2.9-5.9,3-8.9,0l-43.2-43.2c-2.7-2.7-2.5-5.7,0-8.2L71.8,76z'
    />
    <path
      fill='#E31837'
