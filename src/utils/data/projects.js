...
// PageNote
import pageNote1 from "../../component-images/project-images/PageNote/01 extension pop up.png";
import pageNote2 from "../../component-images/project-images/PageNote/02 cropper.png";
import pageNote3 from "../../component-images/project-images/PageNote/03 editor.png";
// SEBPO
...
export const projectsData = {
  page_note: {
    ...
    description:
      "This personal project was inspired by my developer communication workflow. On an engineering team, I found myself sending annotated screenshots, but in doing so had to work with a screenshot app and a seperate editor to add annotations. Then I would seperately attach a note to elaborate on the observation. This handy chrome extension packs all of those functionalities into one lightweight tool.",
